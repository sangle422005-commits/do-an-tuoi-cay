...
const transporter = nodemailer.createTransport({
    service: "gmail", 
    auth: { 
        user: "tulatpham@gmail.com", 
        pass: "shvi zcqa urou lmeo" 
    }
});
...
app.post("/sensor-error", async (req, res) => {
    ...
    const mailOptions = {
        from: '"Smart Garden" <tulatpham@gmail.com>', to: "sanglt3989@gmail.com",
        subject: `⚠️ LỖI PHẦN CỨNG: ${sensor}`,
    ...
    try { await transporter.sendMail(mailOptions); res.send("OK"); } catch (err) {}
});
